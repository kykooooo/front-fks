...
const BASE_EXERCISE_BANK: ExerciseDef[] = [
  ...
  // ---------------- BACKFILL CATALOGUE V2 (05/07/2026) ----------------
  // 34 canoniques V2 générables inconnus du front — nom/description repris
  // VERBATIM des fiches éditoriales backend (fks@73bb6e1). Tags dérivés des
  // champs V2 (load/safety/kind). Aucune vidéo inventée (plan de tournage).
  {
    id: "bike_intervals_40_20",
    name: "Vélo intervalles 40\"/20\"",
    description: "Intervalles vélo : 40 s soutenu / 20 s facile. Volume legacy : 10 répétitions, RPE 7-8. Cadence haute, résistance modérée, posture stable.",
    modality: "run",
    intensity: "moderate",
    tags: ["tempo", "knee_stress"],
  },
  {
    id: "circuit_home_cardio",
    name: "Circuit cardio maison",
    description: "Circuit maison 30 s de travail / 15 s de repos, 3-4 tours (structure legacy) : squats sautés, pompes, mountain climbers, fentes alternées, planche.",
    modality: "circuit",
    intensity: "moderate",
    tags: ["impact", "knee_stress", "shoulder_load"],
  },
  {
    id: "circuit_tabata_bodyweight",
    name: "Tabata poids du corps",
    description: "Format Tabata legacy : 4 minutes chrono, 20 s d'effort max / 10 s de repos × 8 rounds. Composants : burpees, mountain climbers, squat jumps, high knees.",
    modality: "circuit",
    intensity: "moderate",
    tags: ["impact", "knee_stress", "spine_load"],
  },
  {
    id: "core_bicycle_crunch",
    name: "Bicycle crunch",
    description: "Allongé, coude vers genou opposé en pédalant. Épaules décollées du sol, mouvement lent et contrôlé.",
    modality: "core",
    intensity: "moderate",
    tags: ["spine_load"],
  },
  {
    id: "core_mcgill_curl_up",
    name: "McGill curl-up",
  ...
  },
  {
    ...
    description: "Position de planche, ramène un genou vers la poitrine en alternance rapide. Core gainé, hanches stables.",
    modality: "core",
    intensity: "moderate",
    tags: [],
  },
  {
    id: "core_v_ups",
    name: "V-ups",
    description: "Allongé, monte simultanément le buste et les jambes pour toucher les pieds, redescends contrôlé.",
    modality: "core",
    intensity: "moderate",
    tags: ["spine_load"],
  },
  {
    id: "mob_inchworm",
    name: "Inchworm",
    description: "Debout, penche-toi et marche les mains au sol jusqu'en planche, puis marche les pieds vers les mains. Redresse-toi.",
    modality: "mobility",
    intensity: "low",
    tags: ["mobility", "spine_load"],
  },
  {
    id: "mob_scorpion_stretch",
    name: "Scorpion",
    description: "Face au sol, bras écartés, lance une jambe vers la main opposée en tournant le bassin. Alterne lentement.",
    modality: "mobility",
    intensity: "low",
    tags: ["mobility", "spine_load"],
  },
  {
    id: "mob_spiderman_walk",
    ...
    modality: "mobility",
    intensity: "low",
    tags: ["mobility", "hip_load"],
  },
  {
    id: "nordic_curl_partner",
    name: "Nordic curl (partenaire)",
    ...
    modality: "strength",
    intensity: "moderate",
    tags: ["hamstring_load", "knee_stress"],
  },
  {
    id: "plyo_pogo_hops_low",
    name: "Pogos bas (faible intensité)",
    description: "Petits rebonds rapides sur l'avant-pied, cheville raide, contact court.",
    modality: "plyo",
    intensity: "moderate",
    tags: ["plyo", "jump", "ankle_stress", "knee_stress", "calf_load"],
  },
  {
    id: "protocol_acceleration_pyramid_10_20_30",
    ...
    modality: "run",
    intensity: "moderate",
    tags: ["impact", "hamstring_load", "knee_stress"],
  },
  {
    id: "row_intervals_500m",
    name: "Rameur intervalles 500 m",
    description: "Répétitions de 500 m rythmées au rameur, récupération 90 s easy (legacy). Volume legacy : 6 répétitions. Tirage jambes-puis-bras, dos neutre.",
    modality: "run",
    intensity: "moderate",
    tags: ["tempo", "spine_load"],
  },
  {
    id: "run_intervals",
    name: "Intervalles de course",
    description: "Canonique paramétrable des intervalles course en travail/récupération. Presets legacy : 30/30 (2×10 et 2×6), 15/15 (2×12 et 2×10), 10/20 (2×10), 20/20 (2×8), 8×200 m. RPE 7-8, course relâchée.",
    modality: "run",
    intensity: "moderate",
    tags: ["impact", "tempo", "hamstring_load", "ankle_stress"],
    defaultSets: 2,
  },
  {
    id: "run_intervals_1000m",
    name: "Intervalles 1000 m",
    description: "Répétitions de 1000 m proche du seuil, récupération 90-120 s easy (legacy). Volume legacy : 4 répétitions (4-5 selon la fiche vma_long_1000). RPE 7-8, allure stable sans sprint final.",
    modality: "run",
    intensity: "moderate",
    tags: ["impact", "tempo", "hamstring_load", "ankle_stress"],
  },
  {
    id: "run_intervals_300m",
    name: "Intervalles 300 m",
    description: "Répétitions de 300 m rythmées, récupération 60-75 s easy (legacy). Volume legacy : 8 répétitions. Objectif : répéter propre, pas de sprint final.",
    modality: "run",
    intensity: "moderate",
    tags: ["impact", "tempo", "hamstring_load", "ankle_stress"],
  },
  {
    ...
    description: "Répétitions de 400 m en allure soutenue (RPE 7-8 legacy), récupération 75-90 s easy ou marche (legacy). Volume legacy : 6 répétitions. Allure stable.",
    modality: "run",
    intensity: "moderate",
    tags: ["impact", "tempo", "hamstring_load", "ankle_stress"],
  },
  {
    id: "run_tempo_cruise_5min",
    name: "Cruise tempo — blocs de 5 min",
    description: "Blocs de 5 minutes en tempo (Z3/Z4 bas), 90 s easy entre les blocs (legacy). Volume legacy : 4 blocs. RPE 6-7, garde le contrôle.",
    modality: "run",
    intensity: "moderate",
    tags: ["impact", "tempo", "hamstring_load", "ankle_stress"],
    defaultSets: 3,
  ...
  {
    id: "run_tempo_cruise_8min",
    name: "Cruise tempo — blocs de 8 min",
    description: "Blocs de 8 minutes en tempo (Z3), 2 minutes easy entre les blocs (legacy). Volume legacy : 3 blocs. RPE 6-7, cadence stable, technique propre.",
    modality: "run",
    intensity: "moderate",
    tags: ["impact", "tempo", "hamstring_load", "ankle_stress"],
    defaultSets: 3,
  ...
  {
    id: "run_threshold_10min",
    name: "Seuil — blocs de 10 min",
    description: "Blocs de 10 minutes proche du seuil (Z4 bas), 3 minutes easy entre les blocs (legacy). Volume legacy : 2 blocs. RPE 7-8, stable, jamais à bloc.",
    modality: "run",
    intensity: "high",
    tags: ["impact", "tempo", "hamstring_load", "ankle_stress"],
    defaultSets: 2,
  ...
  {
    id: "sled_push_heavy",
    name: "Poussée traîneau lourde (sled/prowler)",
    ...
    modality: "strength",
    intensity: "moderate",
    tags: ["impact", "technique", "knee_stress", "spine_load"],
  },
  {
    id: "speed_wall_drill_a_skip",
    ...
    modality: "run",
    intensity: "moderate",
    tags: ["impact", "technique", "ankle_stress", "hamstring_load"],
  },
  {
    id: "speed_wicket_run",
    name: "Wickets (course sur haies basses)",
    ...
    modality: "run",
    intensity: "high",
    tags: ["sprint", "impact", "technique", "hamstring_load", "ankle_stress"],
  },
  {
    ...
    modality: "run",
    intensity: "high",
    tags: ["impact", "technique", "hamstring_load", "ankle_stress"],
  },
  {
    id: "sprint_flying",
    name: "Flying sprint (vitesse lancée)",
    description: "Lancé progressif puis 20m rapides, expositions maxV, repos long, stop si la vitesse baisse.",
    modality: "run",
    intensity: "high",
    tags: ["sprint", "impact", "technique", "hamstring_load", "knee_stress"],
  },
  {
    id: "sprint_max_velocity_exposure",
  ...
  {
    id: "str_archer_pushup",
    name: "Pompes archer",
    description: "Mains écartées, fléchis un bras pendant que l'autre reste tendu sur le côté. Alterne.",
    modality: "strength",
    intensity: "moderate",
    tags: ["shoulder_load"],
  },
  {
    id: "str_clamshell",
    name: "Clamshell",
    description: "Allongé sur le côté, genoux fléchis, ouvre le genou du dessus comme une coquille. Pieds restent collés.",
    modality: "strength",
    intensity: "moderate",
    tags: ["hip_load"],
  },
  {
    id: "str_fire_hydrant",
    name: "Fire hydrant",
    description: "À 4 pattes, lève le genou sur le côté en gardant 90° de flexion, contrôle la descente. Core gainé.",
    modality: "strength",
    intensity: "moderate",
    tags: ["hip_load"],
  },
  {
    id: "str_pike_pushup",
    name: "Pompes pike (poussée verticale)",
    description: "Position en V inversé (fesses en l'air), fléchis les coudes pour amener la tête vers le sol, pousse pour remonter.",
    modality: "strength",
    intensity: "moderate",
    tags: ["shoulder_load"],
  },
  {
    id: "str_pistol_squat_assisted",
    name: "Pistol squat assisté",
    description: "Squat sur une jambe en se tenant à un support (mur, poteau, chaise). Descends le plus bas possible, genou dans l'axe.",
    modality: "strength",
    intensity: "moderate",
    tags: ["knee_stress", "ankle_stress"],
  },
  {
    id: "str_superman_hold",
    name: "Superman (tenue)",
    description: "Allongé face au sol, lève bras et jambes simultanément, maintiens la position en serrant les fessiers et le dos.",
    modality: "strength",
    intensity: "moderate",
    tags: ["spine_load"],
  },
  {
    id: "treadmill_intervals_60_60",
    name: "Tapis intervalles 60\"/60\"",
    description: "Intervalles tapis : 60 s soutenu / 60 s easy, inclinaison 0-2 % (legacy). Volume legacy : 12 répétitions, RPE 7-8, pas de sprint.",
    modality: "run",
    intensity: "moderate",
    tags: ["impact", "tempo", "knee_stress", "ankle_stress"],
  },
];
