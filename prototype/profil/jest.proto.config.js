// prototype/profil/jest.proto.config.js
// =============================================================================
...
//   - ne ramasse QUE `__tests__/profilVNext/`.
//
//   node prototype/profil/verifier.js tests
//   ou : npx jest --config prototype/profil/jest.proto.config.js
// =============================================================================
"use strict";
...
module.exports = {
  ...
  // n'a pas ce probleme.
  testRegex: "__tests__[\\\\/]profilVNext[\\\\/].*\\.test\\.tsx?$",
