...
const styles = StyleSheet.create({
  ...
  heroSubtitle: { fontSize: TYPE.caption.fontSize, color: palette.sub, marginTop: 3 },
  heroClub: { fontSize: TYPE.caption.fontSize, color: palette.text, fontWeight: "700", marginTop: 6 },
  heroStats: {
    flexDirection: "row",
    alignItems: "center",
    marginTop: 12,
  ...
  heroStatValue: { color: palette.text, fontSize: TYPE.body.fontSize, fontWeight: "800" },
  heroStatLabel: { color: palette.sub, fontSize: TYPE.micro.fontSize },
  ...
  loaderText: { color: palette.sub, fontSize: TYPE.caption.fontSize },
  emptyState: {
    alignItems: "center",
    paddingVertical: 24,
    gap: 8,
  },
  emptyStateTitle: { color: palette.text, fontWeight: "800", fontSize: TYPE.body.fontSize },
  emptyTitle: { color: palette.text, fontWeight: "800", fontSize: TYPE.body.fontSize },
  emptySub: { color: palette.sub, fontSize: TYPE.caption.fontSize, lineHeight: 18, textAlign: "center" },
  searchInput: {
    borderWidth: 1,
  ...
  playerName: { color: palette.text, fontWeight: "800", fontSize: TYPE.body.fontSize },
  playerMeta: { color: palette.sub, fontSize: TYPE.caption.fontSize, marginTop: 2 },
  // Tabs styles
  tabsRow: {
    flexDirection: "row",
    backgroundColor: palette.card,
