...
export default function ProfileSetupScreen({ onProfileCompleted }: ProfileSetupScreenProps = {}) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (__DEV__) console.log("[RECETTE] setDoc profil OK");
      ...
      if (__DEV__) console.log("[RECETTE] appel onProfileCompleted (présent: " + Boolean(onProfileCompleted) + ")");
      ...
      if (__DEV__) console.log("[RECETTE] handleSave ERREUR: " + String(error));
      runShake(shake);
      haptics.error();
