...
export const PREBUILT_SESSIONS: Prebuilt[] = [
  ...
  // ============================================================
  {
    ...
    intensity: "easy",
    duration: "8-10 min",
    objective: "Réveille muscles et articulations avant l'effort",
    focus: "mobility",
    location: "home",
    equipment: [],
  ...
  },
  {
    ...
    intensity: "moderate",
    duration: "10-12 min",
    objective: "Réveille le système nerveux avant tes sprints",
    focus: "speed",
    location: "pitch",
    equipment: ["Cônes"],
  ...
  },
  {
    ...
    intensity: "easy",
    duration: "20-25 min",
    objective: "Bouge en douceur pour mieux récupérer le lendemain",
    focus: "mobility",
    location: "home",
    equipment: ["Tapis"],
  ...
  },
  {
    ...
    intensity: "easy",
    duration: "25-30 min",
    objective: "Le protocole complet pour récupérer après un match",
    focus: "mobility",
    location: "home",
  ...
  },
  {
    ...
    intensity: "easy",
    duration: "10-12 min",
    objective: "Détends ton corps et ton esprit avant de dormir",
    focus: "mobility",
    location: "home",
    equipment: ["Tapis"],
  ...
  // ============================================================
  {
    ...
    intensity: "easy",
    duration: "8 min",
    objective: "Gagne en amplitude de hanches en 8 minutes",
    focus: "mobility",
    location: "home",
    equipment: [],
  ...
  },
  {
    ...
    intensity: "easy",
    duration: "6 min",
    objective: "Travaille la mobilité et la stabilité de tes chevilles",
    focus: "mobility",
    location: "home",
    equipment: [],
  ...
  },
  {
    ...
    intensity: "easy",
    duration: "7 min",
    objective: "Gagne en mobilité du dos et des épaules",
    focus: "mobility",
    location: "home",
    equipment: [],
  ...
  },
  {
    ...
    intensity: "easy",
    duration: "10 min",
    objective: "10 min pour réveiller tout le corps le matin",
    focus: "mobility",
    location: "home",
    equipment: [],
  ...
  },
  {
    ...
    intensity: "easy",
    duration: "5 min",
    objective: "Défais la raideur après une position assise prolongée",
    focus: "mobility",
    location: "home",
    equipment: [],
  ...
  // ============================================================
  {
    ...
    intensity: "moderate",
    duration: "15-18 min",
    objective: "Renforce tes ischios en excentrique, la clé anti-claquage",
    focus: "strength",
    location: "home",
  ...
  },
  {
    ...
    intensity: "moderate",
    duration: "15-18 min",
    objective: "Renforce tes adducteurs pour limiter le risque de pubalgie",
    focus: "strength",
    location: "home",
    equipment: ["Tapis"],
  ...
  },
  {
    ...
    intensity: "moderate",
    duration: "18-20 min",
    objective: "Stabilise tes genoux pour limiter le risque de blessure",
    focus: "strength",
    location: "home",
    equipment: ["Mini-band"],
  ...
  },
  {
    ...
    intensity: "moderate",
    duration: "15 min",
    objective: "Renforce tes chevilles pour limiter le risque d'entorse",
    focus: "strength",
    location: "home",
    equipment: ["Mini-band"],
  ...
  },
  {
    ...
    intensity: "moderate",
    duration: "12-15 min",
    objective: "Un gainage anti-rotation pour mieux résister dans les duels",
    focus: "strength",
    location: "home",
    equipment: ["Élastique"],
  ...
  // ============================================================
  {
    ...
    intensity: "easy",
    duration: "20-25 min",
    objective: "Reste actif sans te fatiguer la veille du match",
    focus: "mobility",
    location: "pitch",
    equipment: ["Cônes"],
  ...
  },
  {
    ...
    intensity: "easy",
    duration: "5-7 min",
    objective: "Reste chaud pour aborder la 2e mi-temps prêt",
    focus: "mobility",
    location: "pitch",
    equipment: [],
  ...
  },
  {
    ...
    intensity: "easy",
    duration: "25-30 min",
    objective: "Fais circuler le sang pour récupérer après le match",
    focus: "mobility",
    location: "home",
    equipment: ["Tapis", "Foam roller"],
  ...
  // ============================================================
  {
    ...
    intensity: "easy",
    duration: "18-20 min",
    objective: "Jour 1 : évalue et débloque tes hanches",
    focus: "mobility",
    location: "home",
    equipment: [],
  ...
  },
  {
    ...
    intensity: "easy",
    duration: "18-20 min",
    objective: "Jour 2 : gagne en rotation du dos et des épaules",
    focus: "mobility",
    location: "home",
    equipment: [],
  ...
  },
  {
    ...
    intensity: "easy",
    duration: "20 min",
    objective: "Jour 3 : assouplis ischios et dos sans perdre de force",
    focus: "mobility",
    location: "home",
    equipment: [],
  ...
  },
  {
    ...
    intensity: "easy",
    duration: "18 min",
    objective: "Jour 4 : travaille la mobilité de tes chevilles",
    focus: "mobility",
    location: "home",
    equipment: [],
  ...
  },
  {
    ...
    intensity: "easy",
    duration: "18 min",
    objective: "Jour 5 : prépare tes adducteurs aux changements de direction",
    focus: "mobility",
    location: "home",
    equipment: [],
  ...
  },
  {
    ...
    intensity: "easy",
    duration: "22-25 min",
    objective: "Jour 6 : enchaîne tout ce que tu as travaillé cette semaine",
    focus: "mobility",
    location: "home",
    equipment: [],
  ...
  },
  {
    ...
    intensity: "easy",
    duration: "20-22 min",
    objective: "Jour 7 : compare tes tests au jour 1",
    focus: "mobility",
    location: "home",
    equipment: [],
  ...
  // ============================================================
  {
    ...
    intensity: "moderate",
    duration: "5 min",
    objective: "5 min de gainage, sans pause entre les exercices",
    focus: "strength",
    location: "home",
    equipment: [],
  ...
  },
  {
    ...
    intensity: "moderate",
    duration: "8-12 min",
    objective: "100 squats, chronométrés, à ton rythme",
    focus: "strength",
    location: "home",
    equipment: [],
  ...
  },
  {
    ...
    intensity: "easy",
    duration: "15 min",
    objective: "Un test rapide pour repérer tes points faibles",
    focus: "mobility",
    location: "home",
    equipment: [],
  ...
  },
  {
    ...
    intensity: "easy",
    duration: "3 min",
    objective: "3 min, zéro matériel, pour bouger un minimum",
    focus: "mobility",
    location: "home",
    equipment: [],
  ...
  // ============================================================
  // CIRCUITS — Entraînements complets en circuit
  // ============================================================
  {
    category: "CIRCUITS",
    title: "Circuit HIIT terrain",
    intensity: "hard",
    duration: "20-25 min",
    objective: "Un circuit cardio intense en 4 tours, sur le terrain",
    focus: "circuit",
    location: "pitch",
    equipment: ["Cônes"],
    ...
    rpe_target: 8,
    detail: [
      "ÉCHAUFFEMENT — 4 min de footing + mobilité dynamique hanches/chevilles",
      "",
      "⏱ 4 tours — 30\" travail / 15\" repos par exercice, 1 min repos entre les tours",
      "",
      "1. Sprint navette 10-20-10 m — Sprint 10 m, touche le sol, 20 m, touche, 10 m retour. Explosif à chaque départ",
      "2. Burpees — Descends au sol poitrine, pousse, saute bras en l'air. Rythme soutenu sans casser la forme",
      "3. Shuffle latéral 10 m + sprint 20 m — Pas chassés entre 2 cônes puis sprint droit. Appuis bas et rapides",
      "4. Mountain climbers — Position pompe, ramène les genoux vers la poitrine en alternant le plus vite possible",
      "5. Sprint 40 m @ 90% — Sprint quasi-max sur la longueur, reviens en marchant pour la récup",
      "",
      "RETOUR AU CALME — 3 min de marche + étirements légers",
    ],
    expectations: [
      "Intensité max sur chaque intervalle.",
      "La récup entre les tours est essentielle — ne la saute pas.",
      "Si tu tiens les 4 tours proprement, t'es prêt pour 90 min.",
    ],
  },
  {
    category: "CIRCUITS",
    title: "Circuit force-endurance maison",
    intensity: "moderate",
    duration: "25-30 min",
    objective: "Un circuit jambes en 3 tours, à la maison",
    focus: "circuit",
    location: "home",
    equipment: [],
    tags: ["Force", "Endurance", "Maison"],
    level: "Tout niveau",
    rpe_target: 7,
    detail: [
      "ÉCHAUFFEMENT — 3 min de jumping jacks + squats légers + montées de genoux",
      "",
      "⏱ 3 tours — Enchaîne les 6 exercices, 45\" repos entre les tours",
      "",
      "1. Squat poids du corps — 15 reps. Descends cuisses parallèles au sol, pousse fort sur les talons pour remonter",
      "2. Pompes — 12 reps (ou sur les genoux). Poitrine frôle le sol, coudes à 45°, corps gainé",
      "3. Fentes alternées — 10 / jambe. Grand pas avant, genou arrière frôle le sol, buste droit",
      "4. Planche — 40\". Sur les coudes, corps aligné de la tête aux pieds, fessiers serrés",
      "5. Jump squats — 10 reps. Squat puis saute le plus haut possible, réception souple sur les orteils",
      "6. Superman hold — 30\". Sur le ventre, décolle bras et jambes, serre le dos et les fessiers",
      "",
      "RETOUR AU CALME — 3 min d'étirements : cuisses, ischios, pectoraux, dos",
    ],
    expectations: [
  ...
  },
  {
    ...
    intensity: "hard",
    duration: "18-22 min",
    objective: "Travaille l'explosivité de tes premiers appuis",
    focus: "circuit",
    location: "pitch",
    equipment: ["Cônes"],
    tags: ["Explosif", "Vitesse", "Appuis"],
    level: "Amateur / semi-pro",
    rpe_target: 8,
    detail: [
      "ÉCHAUFFEMENT — 5 min : footing léger + gammes athlétiques + 3 accélérations progressives",
      "",
      "⏱ 3 tours — Récup complète 90\" entre les tours (qualité > fatigue)",
      "",
      "1. Départs en déséquilibre 3 x 10 m — Tombe en avant, rattrape-toi en sprintant. Explosivité du 1er pas",
      "2. Sauts en contrebas + sprint 15 m — Saute d'une marche (30 cm), réception → sprint immédiat. Réactivité",
      "3. Slalom 5 cônes + sprint 20 m — Zigzag serré entre les cônes puis sprint linéaire. Appuis + vitesse",
      "4. Pogo hops 2 x 8 — Sauts chevilles rigides, rebonds rapides. Raideur cheville = vitesse",
      "5. Sprint 30 m départ allongé — Couché sur le ventre, au signal lève-toi et sprinte. Réaction + accélération",
      "",
      "RETOUR AU CALME — 3 min de marche + étirements mollets et quadriceps",
    ],
    expectations: [
      "Récup COMPLÈTE entre les tours — c'est du travail nerveux, pas du cardio.",
      "Chaque sprint doit être à 95-100%. Si tu ralentis, prends plus de repos.",
      "Idéal 2x/semaine, jamais la veille d'un match.",
    ],
  },
  {
    category: "CIRCUITS",
    title: "Circuit haut du corps duels",
    intensity: "moderate",
    duration: "20-25 min",
    objective: "Renforce le haut du corps pour les contacts et duels",
    focus: "circuit",
    location: "home",
    equipment: ["Élastique"],
    tags: ["Haut du corps", "Duels", "Force"],
    level: "Tout niveau",
    rpe_target: 7,
    detail: [
      "ÉCHAUFFEMENT — 3 min : circles d'épaules, band pull-aparts, pompes lentes x5",
      "",
      "⏱ 3 tours — 45\" travail / 15\" repos par exercice, 1 min repos entre les tours",
      "",
      "1. Pompes explosives — Descends contrôlé 2s, pousse explosif (mains décollent si possible). Force de poussée",
      "2. Band pull-apart — Élastique devant toi, écarte les bras en serrant les omoplates. Stabilité épaules",
      "3. Pike push-ups — Pieds sur une chaise, fesses en l'air, pompe verticale. Épaules et triceps",
      "4. Planche commando — Alterne coudes/mains sans tourner le bassin. Gainage anti-rotation",
      "5. Band rows — Élastique accroché, tire les coudes en arrière en serrant le dos. Dos de duelliste",
      "6. Diamond push-ups — Mains jointes sous la poitrine. Triceps pour repousser les adversaires",
      "",
      "RETOUR AU CALME — 2 min : étirements pectoraux + épaules + poignets",
    ],
    expectations: [
      "Le haut du corps est sous-estimé au foot — c'est lui qui gagne les duels.",
      "Contrôle le mouvement, pas de reps bâclées.",
      "Ajoute un tour quand 3 tours deviennent faciles.",
    ],
  },
  {
    category: "CIRCUITS",
    title: "Circuit full body express",
    intensity: "moderate",
    duration: "15-18 min",
    objective: "15 min de circuit complet, sans matériel",
    focus: "circuit",
    location: "home",
    equipment: [],
    tags: ["Express", "Full body", "Rapide"],
    level: "Tout niveau",
    rpe_target: 7,
    detail: [
      "ÉCHAUFFEMENT — 2 min : jumping jacks + squats légers + rotations de buste",
      "",
      "⏱ 4 tours — Enchaîne tout sans repos entre les exos, 45\" repos entre les tours",
      "",
      "1. Squat + saut — 8 reps. Squat profond puis saute explosif, réception contrôlée. Puissance jambes",
      "2. Pompes — 10 reps. Poitrine au sol, coudes à 45°, remonte en un bloc. Force poussée",
      "3. Fentes sautées — 6 / jambe. Fente puis saute et change de jambe en l'air. Explosivité + équilibre",
      "4. Planche dynamique — 30\". Alterne levée d'un bras puis d'une jambe, corps stable. Gainage total",
      "5. Burpee — 6 reps. Au sol, pompe, debout, saute. Le mouvement complet par excellence",
      "",
      "RETOUR AU CALME — 2 min : respiration profonde + étirements quadriceps et ischios",
    ],
    expectations: [
      "15 min chrono, zéro excuse.",
      "Parfait les jours où t'as pas le temps mais tu veux quand même bosser.",
      "Fais-le proprement — 15 min intenses > 1h molle.",
    ],
  },
];
