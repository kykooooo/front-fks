...
const baseExternalState = () => ({
  ...
  clubTrainingsPerWeek: null as number | null,
  matchesPerWeek: null as number | null,
  targetFksSessionsPerWeek: null as number | null,
  ...
  persist(
    ...
    }),
    {
      ...
      partialize: (s) => ({
        ...
        clubTrainingsPerWeek: s.clubTrainingsPerWeek ?? null,
        matchesPerWeek: s.matchesPerWeek ?? null,
